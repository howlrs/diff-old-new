...
> ⚠ **このファイルは古い** (Phase 3 80% プロト完了時点). 最新は [`HANDOFF-2026-05-05.md`](HANDOFF-2026-05-05.md) を参照してください.
> 次セッションは新ファイルから読み始めること.
...
- algo runtime 15 caller の `// TODO(PR-B2b)` placeholder 全消去
...
- `executor-server --mode mock` smoke test 確認済 (`/v1/health` 200)
